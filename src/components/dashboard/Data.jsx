...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Diki Maulana
            ...
            <h3 className="home__subtitle">Junior Programmer</h3>
            <p className="home__description">saya lulusan dari teknik informatika dengan jurusan sistem informasi
            yang memiliki minat yang tinggi di bidang programming, project yang telah dibuat sendiri menggunakan bahasa
            pemrograman javascript, css php dan html dengan framework laravel atau next js serta library react js dan bootstraps
            </p>
