...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm(
        'service_yl4srzf', 
        'template_9odymwt',
       form.current, 'Ch1JA0CUaFv_ewMK7')
        .then((result) => {
        ...
        <div className="contact__container container grid">
            ...
            <div className="contact__info">
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">maulanadiki23@gmail.com</span>
                    <a href="mailto:maulanadiki23@gmail.com" className="contact__button">Write Me
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">+62857-7100-3299</span>
                    <a href="https://api.whatsapp.com/send?phone=6285771003299&text=Hello, for more information" className="contact__button">Write Me
                    <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                    </a>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">maulanadiki23</span>
